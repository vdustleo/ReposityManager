...
<div class="cboth"></div>
<div class="func_title">出库记录</div>
<button id="print_record" class="oper_btn">打印出库记录</button>
<div class="statistic_info">
    出库次数: <span id="sum_record"></span>
    出库数量: <span id="sum_goods"></span>
</div>
<table id="storage_data"></table>
<div id="storage_data_pager"></div>
<script type="text/javascript" src="js/storage/storage_out_record.js"></script>